...
def get_session(request):
    ...
    # FIX: Manejar grupo de forma segura
    first_group = user.groups.first()
    data["group"] = first_group.name if first_group else None
    ...
    try:
        ...
        data.update({
            ...
            "appointment_buffer_time": staff_member.get_appointment_buffer_time(),
        })
...
def login_user(request):
    ...
    if staff:
        staff_info = {
            ...
            "service": [s.name for s in staff.services_offered.all()],
        }
    else:
        staff_info = None
